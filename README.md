...
| Field | Value |
|---|---|
| **Git Repository URL** | https://github.com/Jishin-John/Catalyst-AI-Powered-Skill-Assessment-Personalised-Learning-Platform |
| **Git Username** | Jishin-John |
| **Project Documentation** | See README.md and ARCHITECTURE.md in this repo |
| **Demo Video Link** | https://drive.google.com/drive/u/2/folders/1o0K8MqkuBzpGMIqkTGVDjinwAWZUs22c |
| **Project Site URL** | https://catalyst-ai-powered-skill-assessment-personalised-learning-pla.streamlit.app/ |

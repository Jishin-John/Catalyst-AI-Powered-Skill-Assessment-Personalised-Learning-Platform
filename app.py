...
<style>
    ...
    * {box-sizing: border-box;}
    ...
    .portal-btn.candidate-btn {
        background: linear-gradient(135deg, #667eea, #764ba2);
        box-shadow: 0 8px 24px rgba(102,126,234,0.4);
    }

    .portal-btn.candidate-btn:hover {
...
for i in range(20):
    ...
    <div class="particle" style="
        ...
        background:rgba({random.randint(100,200)},{random.randint(100,200)},234,0.5);
    "></div>
    """
    ...
    <div class="portals-row">
        <div class="portal-card candidate">
            ...
            <div class="feature-tags">
                ...
                <span class="feature-tag">Anti-Cheat Timer</span>
                <span class="feature-tag">XP + Badges</span>
                <span class="feature-tag">Skill Sprint Game</span>
